...
namespace SevenZip.Compression.LZMA
{
    public class Decoder : ICoder, ISetDecoderProperties
    {
        ...
        private class LiteralDecoder
        {
            ...
            {
                return (uint) ((int) ((pos & m_PosMask) << m_NumPrevBits) + (prevByte >> 8 - m_NumPrevBits));
            }
            ...
            public byte DecodeWithMatchByte(SevenZip.Compression.RangeCoder.Decoder rangeDecoder, uint pos,
        ...
        public void SetDecoderProperties(byte[] properties)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                num3 = (uint) ((int) num3 + (properties[1 + i] << i * 8));
            }
