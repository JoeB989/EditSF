    ...
    public class BinTree : InWindow, IMatchFinder, IInWindowStream
    {
        ...
        public uint GetMatches(uint[] distances)
        {
            ...
            if (HASH_ARRAY)
            {
                ...
                num6 = (num8 & 0x3FF);
                num8 = (uint) ((int) num8 ^ (_bufferBase[num4 + 2] << 8));
                num7 = (num8 & 0xFFFF);
            ...
            if (kNumHashDirectBytes != 0 && num10 > num3 && _bufferBase[_bufferOffset + num10 + kNumHashDirectBytes] !=
                _bufferBase[num4 + kNumHashDirectBytes])
            {
            ...
            while (true)
            {
                ...
                uint num16 = ((num15 <= _cyclicBufferPos)
                                 ? (_cyclicBufferPos - num15)
                                 : (_cyclicBufferPos - num15 + _cyclicBufferSize)) << 1;
        ...
        public void Skip(uint num)
        {
            do
            {
                ...
                if (HASH_ARRAY)
                {
                    ...
                    _hash[num6] = _pos;
                    num5 = (uint) ((int) num5 ^ (_bufferBase[num4 + 2] << 8));
                ...
                while (true)
                {
                    ...
                    uint num13 = ((num12 <= _cyclicBufferPos)
                                     ? (_cyclicBufferPos - num12)
                                     : (_cyclicBufferPos - num12 + _cyclicBufferSize)) << 1;
